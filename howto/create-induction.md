...
![moodle1.png](/howto/moodle/moodle1.png =x800)
3. Scroll down and add a short description and image of the tool (you can just copy these from the wiki page).
![moodle2.png](/howto/moodle/moodle2.png =x800)
4. Under "Appearance" set "Course announcements" to 0.

5. Scroll down and tap "Save and display" to continue.
![moodle3.png](/howto/moodle/moodle3.png =x800)
